            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 20) {
                    Group {
                        ...
                        Text("Please read these Terms of Service (\"Terms\") carefully before using the ColorCrafter mobile application (the \"App\") operated by MyLogic Studio LLC (\"us\", \"we\", or \"our\").")
                    ...
                    Group {
                        ...
                        Text("• You retain all rights to the images you upload to the App.")
                            .fixedSize(horizontal: false, vertical: true)
                        Text("• You grant us a non-exclusive, worldwide, royalty-free license to use, process, modify, and store your uploaded images solely for the purpose of providing our services to you.")
                            .fixedSize(horizontal: false, vertical: true)
                    ...
                    Group {
                        Text("6. Intellectual Property")
                            .font(.headline)
                        Text("• The App, including all content, features, and functionality, is owned by MyLogic Studio LLC and is protected by United States and international copyright, trademark, patent, trade secret, and other intellectual property laws.")
                            .fixedSize(horizontal: false, vertical: true)
                        Text("• ColorCrafter is a trademark of MyLogic Studio LLC.")
                            .fixedSize(horizontal: false, vertical: true)
                    ...
                    Group {
                        ...
                        Text("MyLogic Studio LLC DOES NOT WARRANT THAT: (A) THE APP WILL FUNCTION UNINTERRUPTED, SECURE OR AVAILABLE AT ANY PARTICULAR TIME OR LOCATION; (B) ANY ERRORS OR DEFECTS WILL BE CORRECTED; (C) THE APP IS FREE OF VIRUSES OR OTHER HARMFUL COMPONENTS; OR (D) THE RESULTS OF USING THE APP WILL MEET YOUR REQUIREMENTS.")
                            .font(.caption)
                            .fixedSize(horizontal: false, vertical: true)
                    }
                    ...
                    Group {
                        Text("8. Limitation of Liability")
                            .font(.headline)
                        Text("IN NO EVENT SHALL MyLogic Studio LLC BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL OR PUNITIVE DAMAGES, INCLUDING WITHOUT LIMITATION, LOSS OF PROFITS, DATA, USE, GOODWILL, OR OTHER INTANGIBLE LOSSES, RESULTING FROM YOUR ACCESS TO OR USE OF OR INABILITY TO ACCESS OR USE THE APP.")
                            .font(.caption)
                            .fixedSize(horizontal: false, vertical: true)
                    }
