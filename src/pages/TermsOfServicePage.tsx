    ...
    <>
      ...
      <ContentContainer>
        ...
        <TermsText>
          ...
          application (the "App") operated by MyLogix Studio LLC ("us", "we", or "our").
        </TermsText>
        ...
        <TermsList>
          ...
          <TermsListItem>
            ColorCrafter is a trademark of MyLogix Studio LLC.
          </TermsListItem>
          <TermsListItem>
        ...
        <Disclaimer>
          ...
          <br /><br />
          MyLogix Studio LLC DOES NOT WARRANT THAT: (A) THE APP WILL FUNCTION UNINTERRUPTED, 
